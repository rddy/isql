...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        temperature_ph = tf.placeholder(tf.float32, (), name="temperature")
        #'''
        gumbel_noise = -tf.log(-tf.log(tf.random_uniform(tf.shape(q_values))))
        output_actions = tf.argmax(temperature_ph*q_values+gumbel_noise, axis=1)
        '''
        ...
        act = U.function(inputs=[observations_ph, stochastic_ph, update_eps_ph, temperature_ph],
...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        if double_q:
            ...
            q_tp1_best = tf.reduce_logsumexp(q_tp1, 1)
